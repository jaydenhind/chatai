...
export function ChatPanel({
  ...
  const exampleMessages = [
    {
      heading: 'Query Subject Areas',
      subheading: 'What are the subject areas offered at Manning"s School?',
      message: 'What are the subject areas offered at Mannings School?'
    },
    {
      heading: 'Query Sixth Form Program',
      subheading: 'What is the sixth form program like?',
      message: 'What is the sixth form program like',
    }
  ]
